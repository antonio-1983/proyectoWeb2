package com.web2.proyecto.Helpers;
...
public class ViewRouteHelper {
	...
	//USUARIO
	public final static String FORM_USUARIO = "usuario/formUsuario";
	public final static String NUEVO_USUARIO = "usuario/nuevoUsuario";
